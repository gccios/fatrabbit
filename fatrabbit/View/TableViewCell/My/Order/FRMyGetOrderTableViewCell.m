...
@interface FRMyGetOrderTableViewCell ()
...
@implementation FRMyGetOrderTableViewCell
...
- (void)configWithModel:(FRMyServiceOrderModel *)model
{
    ...
    switch (model.type) {
        case 1:
        {
            ...
            [self.rightHandleButton setTitle:@"完成服务" forState:UIControlStateNormal];
        ...
        case 3:
        {
            ...
            [self.rightHandleButton setTitle:@"联系Ta" forState:UIControlStateNormal];
